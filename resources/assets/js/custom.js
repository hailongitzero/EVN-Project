jQuery(document).ready(function () {
    ...
    function initChat() {
        ...
        var imagePath = 'resources/assets/images/misc/';
    ...
    window.emojiPicker = new EmojiPicker({
        ...
        assetsPath: 'resources/assets/images/emoji/',
    ...
    $.simpleWeather({
        ...
        success: function (weather) {
            ...
            html += '<img alt="img" src="resources/assets/images/weather/large-icon.png">';
            ...
            for (var i = 1; i <= 7; i++) {
                ...
                html += '<div class="forcast-icon"><img alt="img" src="resources/assets/images/weather/' + i + '.png"></div>';
